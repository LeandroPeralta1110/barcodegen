<div class="h-screen flex">
    <div class="w-full p-8 flex space-x-4">
        <div class="w-1/2 flex flex-col items-center bg-white border border-gray-300 p-4 rounded-md">
            <div class="mb-4">
                <label for="" class="control-label mt-2 w-full text-left">Producto</label>
            ...
            <div class="mb-4">
                <label for="" class="control-label mt-2 w-full text-left">Tipo de Código de Barras</label>
            ...
            <div class="mb-4">
                <label for="cantidadCodigos" class="control-label mt-2 w-full text-left">Cantidad de Códigos de Barras a Generar</label>
            ...
            <div class="mb-4">
                <label for="scannedCodeInput" class="control-label mt-2 w-full text-left"></label>
